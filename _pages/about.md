...
My research is concerned with helping programmers ensure that software and AI systems are correct, safe, and trustworthy. To achieve this, I study **Formal Methods** and their applications to **Program Analysis and Verification**, as well as **Trustworthy AI and Safe Autonomy**. The long term goal of my work is to advance the theory and automation of formal methods for certifying software and AI systems, especially in the presence of **probabilistic uncertainty**. My work is concerned with both theoretical aspects of formal reasoning about probabilistic systems, as well as the development of automated methods to help programmers build correct software and AI systems in practice. My current research interests include:
