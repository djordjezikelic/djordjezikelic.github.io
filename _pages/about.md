...
1. Program Analysis and Verification
    ...
    - Efficient quantifier elimination for template-based synthesis in programs ([AAAI25b](https://ojs.aaai.org/index.php/AAAI/article/view/33213), [arXiv24](https://arxiv.org/abs/2408.03796))
2. Trustworthy AI and Safe Autonomy
    ...
    - Formal verification and planning in Markov models ([CAV25](https://arxiv.org/abs/2505.18833), [IJCAI24a](https://arxiv.org/abs/2405.04015), [IJCAI24b](https://arxiv.org/abs/2312.13912), [CAV23](https://link.springer.com/chapter/10.1007/978-3-031-37709-9_5), [FSTTCS22](https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.FSTTCS.2022.29))
...
* <span style="color:grey">May 2025</span>\. [Omega-regular Verification and Control for Distributional Specifications in MDPs](https://djordjezikelic.github.io/) accepted at [CONCUR 2025](https://conferences.au.dk/confest2025/concur).
