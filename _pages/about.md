...
The central theme of my work is the development of formal methods and automated reasoning techniques for **stochastic systems**. Stochastic systems provide a formal framework for modeling and quantifying uncertainty that may arise due to randomization, interaction with uncertain environments or inference from data. My goal is to contribute to laying theoretical and algorithmic foundations of formal verification techniques for stochastic systems towards enhancing safety and trustworthiness of software and AI systems even in the presence of uncertainty. More concretely, my work focuses on probabilistic program analysis, formal verification of Markov models, stochastic control and safe reinforcement learning.

I am also interested in static analysis of non-probabilistic programs and other aspect of verification of systems with learned and neural components. My work on probabilistic program analysis, particularly on automation aspects, often draws insight from past developments in non-probabilistic program analysis. To that end I also work on static analysis in non-probabilistic programs and my work has lead to advances in static analysis for termination and cost properties. Furthermore, towards enhancing safety and trustworthiness of AI systems, I also work on formal verification of systems with learned and neural components. Finally, I am interested in the formal strategy synthesis in games on graphs.
