...
My research is concerned with developing algorithms for formally verifying correctness of software. In particular, I combine ideas from **Formal Verification**, **Programming Languages** and **Machine Learning** research towards designing mathematically rigorous yet fully automated and scalable methods for formal analysis of programs, systems with learned components and safe learning. I work in the broad areas of formal verification, program analysis and AI safety.

The central theme of my work is the development of formal methods and automated reasoning techniques for **stochastic systems**, where I am interested in probabilistic program analysis, stochastic control and safe reinforcement learning. However, my research is not restricted to stochastic systems and I also work on static analysis of non-probabilistic programs, other aspects of verification of systems with learned components and on games on graphs.
